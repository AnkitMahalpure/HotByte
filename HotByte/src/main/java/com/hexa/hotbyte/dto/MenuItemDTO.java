...
public class MenuItemDTO {
	...
	public String toString() {
		return "MenuItemDTO [menuItemName=" + menuItemName + ", hotelID=" + hotelID + ", menuItemImage=" + menuItemImage
				+ ", menuItemPrice=" + menuItemPrice + ", menuItemType=" + menuItemType + ", menuItemDescription="
				+ menuItemDescription + ", isVeg=" + isVeg + ", menuItemRating=" + menuItemRating + "]";
	}
