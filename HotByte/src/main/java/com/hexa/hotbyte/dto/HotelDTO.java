...
public class HotelDTO {
	...
	public HotelDTO(Long hotelId, String hotelName, Address hotelAddress, String hotelContactNumber,
			String hotelDescription, List<String> hotelImagesList, boolean hotelIsActive, LocalTime hotelStartTiming,
	...
	public String toString() {
		return "HotelDTO [hotelId=" + hotelId + ", hotelName=" + hotelName + ", hotelAddress=" + hotelAddress
				...
				+ ", hotelImagesList=" + hotelImagesList + ", hotelIsActive=" + hotelIsActive + ", hotelStartTiming="
				+ hotelStartTiming + ", hotelEndTiming=" + hotelEndTiming + ", hotelRating=" + hotelRating + "]";
	}
