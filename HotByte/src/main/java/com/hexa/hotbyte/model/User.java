...
public class User implements UserDetails {
	...
	public User(Long userId, String username, String password, String email, Role role, String userGender,
			String userContactNumber, Address address, List<Order> orders, Map<Long, Integer> cart) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "User [userId=" + userId + ", username=" + username + ", password=" + password + ", email=" + email
				+ ", role=" + role + ", userGender=" + userGender + ", userContactNumber=" + userContactNumber
