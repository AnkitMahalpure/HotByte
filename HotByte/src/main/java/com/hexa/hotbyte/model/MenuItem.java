...
//	@JoinColumn(name = "hotelID")
	...
	public MenuItem(Long menuItemID, String menuItemName, int hotelID, String menuItemImage, float menuItemPrice,
			String menuItemType, String menuItemDescription, String isVeg, int menuItemRating) {
		super();
	...
	public String toString() {
		return "MenuItem [menuItemID=" + menuItemID + ", menuItemName=" + menuItemName + ", hotelID=" + hotelID
				+ ", menuItemImage=" + menuItemImage + ", menuItemPrice=" + menuItemPrice + ", menuItemType="
				+ menuItemType + ", menuItemDescription=" + menuItemDescription + ", isVeg=" + isVeg
