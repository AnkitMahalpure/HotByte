...
public class HotelController {
	...
	public ResponseEntity<Order> updateOrderStatus(@RequestParam int statusId,int orderId) {
		return ResponseEntity.ok(orderService.updateOrderStatus(statusId,orderId));
	}
