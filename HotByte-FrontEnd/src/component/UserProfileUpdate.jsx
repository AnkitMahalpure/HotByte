          ...
          <input
            ...
            onChange={(e) =>
              handleChange({
                target: {
                  name: "address",
                  value: { ...formData.address, street1: e.target.value },
                },
              })
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              handleChange({
                target: {
                  name: "address",
                  value: { ...formData.address, street2: e.target.value },
                },
              })
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              handleChange({
                target: {
                  name: "address",
                  value: { ...formData.address, landmark: e.target.value },
                },
              })
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              handleChange({
                target: {
                  name: "address",
                  value: { ...formData.address, postalCode: e.target.value },
                },
              })
            }
          />
