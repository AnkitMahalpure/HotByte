    ...
    if (hotelCartID === 0) {
      ...
      try {
        const result = await axios.post(
          `http://localhost:8080/user/add-to-cart?userId=${realUser.userId}&menuItemId=${menuID}&quantity=1`,
          {},
          {
            headers: {
    ...
    <div>
      <div className="menuitem">
        <div className="menuitem-desc">
          {menu.isVeg === "Yes" ? (
            <img src={veg} style={{ height: "14px", width: "14px" }} alt="" />
          ) : (
            <img
              src={nonveg}
